...
## Hardware Testing
 ...
 - This is just a quick setup and *NOT* a rigorous test. Take the results with a grain of salt.
 
![alt text](https://github.com/yeoshuyi/Custom-6M-Baud-UART-with-Speculative-FIFO/blob/main/MAP002.BMP "Oscilloscope Reading")<br/>
